...
*                                                                      *
     ...
     &          'FORMATTED' )
      ...
      IF (MREG.EQ.8 .AND. NEWREG.EQ.9 .AND. JTRACK .EQ. 8 ) THEN ! Something crosses into the TPC
            WRITE(99,*) NCASE
      END IF
     ...
     &          'UNFORMATTED' )
      ...
      IF (NEUTRONS) THEN
            ...
            IF((JTRACK.EQ.10) .OR. (JTRACK.EQ.11)) THEN
                  ! If the event generating particle is a MUON (+/-)
* 
            WRITE(72,*) ''
            WRITE(72,*) 'MUON EVENT; From Number:', NCASE
            WRITE(72,*) 'Energy:', ETRACK,' GeV'
            WRITE(72,*) 'Location:', XSCO, YSCO, ZSCO
            WRITE(72,'(a,I3,a,10(I3))') 'Generating ',NP,
     *            ' particles of ID ', (KPART(I),I=1,NP)
            WRITE(72,*) 'With energies: ',(TKI(I), I=1, NP)

            IF(NPHEAV .GT. 0) THEN
                  WRITE(72,'(a,I3)') 'Evaporation Fragments: ',NPHEAV
                  WRITE(72, '(a,10(I3))') 'A = ',(IBHEAV(KHEAVY(I)),I=1,NPHEAV)
                  WRITE(72,'(a,10(I3))') 'Z = ',(ICHEAV(KHEAVY(I)),I=1,NPHEAV)
            END IF

            IF(IBRES .GT. 0) THEN
                  WRITE(72,'(a,I3,a,I3)') 'Residue with A = ',IBRES, ' and Z = ',ICRES
            END IF
            END IF

!             IF((JTRACK.EQ.8)) THEN
!                   ! If the event generating particle is a NEUTRON
! * 
!             WRITE(72,*) ''
!             WRITE(72,*) 'NEUTRON EVENT; From Number', NCASE
!             WRITE(72,*) 'Energy:', ETRACK,' GeV'
!             WRITE(72,*) 'Location:', XSCO, YSCO, ZSCO
!             WRITE(72,'(a,I3,a,10(I3))') 'Generating ',NP,
!      *            ' particles of ID ', (KPART(I),I=1,NP)
