...
\include{sub/prerequisites.tex}

\include{sub/input_file.tex}
...
\include{sub/scoring.tex}


%\part*{The Muon Source User Routine}

\include{sub/muon_source.tex}

%\part*{The Scoring User Routine (`mgdraw.f')}

\include{sub/mgdraw.tex}
